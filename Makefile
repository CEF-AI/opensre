...
# Run synthetic CEF QA RCA benchmark suite via the CLI runner (LLM-scored; needs LLM_PROVIDER set).
# Optional: SCENARIO=tests/synthetic/cef/010-healthy-inference-redherring to run one.
test-cef-synthetic:
	$(PYTHON) -m tests.synthetic.cef.run_suite $(SCENARIO)
