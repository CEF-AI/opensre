    ...
    input_schema={
        ...
        "properties": {
            "topic": {
                "type": "string",
                "description": (
                    "Specific topic: full_qa, investigation_procedure, score_regression, "
                    "pipeline_overview, stages_and_activities, failure_modes, log_markers, "
                    "model_aliases, correlation"
                ),
            },
            "keywords": {
                "type": "array",
